...
public class QueryDslTest {
	...
	@Test
	public void dateRangeSearchTest() throws ElasticsearchException, ParseException, UnknownHostException {
	 ...
	 */
	@Test
	public void simpleSearchTest1() throws ElasticsearchException, ParseException, UnknownHostException {
		@SuppressWarnings("resource")
		Client client = TransportClient.builder().build()
        .addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("host1"), 9300));
		SearchResponse response = client.prepareSearch("fccs")
	 ...
	 */
	@Test
	public void simpleSearchTest2() throws ElasticsearchException, ParseException, UnknownHostException {
		@SuppressWarnings("resource")
		Client client = TransportClient.builder().build()
        .addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("host1"), 9300));
		SearchResponse response = client.prepareSearch("fccs")
			.setTypes("employee")
			.setQuery(QueryBuilders.matchQuery("lastName", "Smith"))
			.setPostFilter(QueryBuilders.rangeQuery("age").gt(30))
			.get();
		SearchHits hits = response.getHits();
		System.out.println(hits.getTotalHits());
		for (int i = 0; i < hits.getHits().length; i++) {
	 ...
	 */
	@Test
	public void documentSearchTest() throws ElasticsearchException, ParseException, UnknownHostException {
		@SuppressWarnings("resource")
		Client client = TransportClient.builder().build()
        .addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("host1"), 9300));
		SearchResponse response = client.prepareSearch("fccs")
	 ...
	 */
	@Test
	public void phraseSearchTest() throws ElasticsearchException, ParseException, UnknownHostException {
		@SuppressWarnings("resource")
		Client client = TransportClient.builder().build()
        .addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("host1"), 9300));
		SearchResponse response = client.prepareSearch("fccs")
	 ...
	 */
	@Test
	public void phrasePrefixSearchTest() throws ElasticsearchException, ParseException, UnknownHostException {
		@SuppressWarnings("resource")
		Client client = TransportClient.builder().build()
        .addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("host1"), 9300));
		SearchResponse response = client.prepareSearch("fccs")
	 ...
	 */
	@Test
	public void highlightSearchTest() throws ElasticsearchException, ParseException, UnknownHostException {
		@SuppressWarnings("resource")
		Client client = TransportClient.builder().build()
        .addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("host1"), 9300));
		SearchResponse response = client.prepareSearch("fccs")
